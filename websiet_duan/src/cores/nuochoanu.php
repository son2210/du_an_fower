...
//  seach 
    if(isset($_GET['name'])){
        ...
        $product="SELECT* FROM product inner join trademark on product.ma_sp= trademark.id_trademark where gioitinh='nu' AND 'name' LIKE '% $seach%' order by id DESC ";
        $query=mysqli_query($new,$product);
    }else{
        $product="SELECT* FROM product inner join trademark on product.ma_sp= trademark.id_trademark where gioitinh='nu' order by id DESC";
        $query=mysqli_query($new,$product);
    }
?>
...
<head>
    ...
    <link rel="stylesheet" href="./src/public/css/home.css?p=6">
...
<nav class="container">
    <div class="menu1">
        ...
        <div class="form-seach">
            <form action="./index.php?page=nuochoanu" method="get">
...
<section class="container">
        ...
        <div class="abc" id="onload">
            ...
            <div class="box1">
                <a href="./index.php?page=sanpham&id=<?=$row_list['id']?>"> <img src="./src/public/upload_img/img_product/<?=$row_list['image']?>"alt="  <?=$row_list['name']?>"></a>
