...
if (isset($_SESSION['user'])) {
    ...
    $name = " <h5 >  Xin Chào : " . $dataUser['email'] . "  </h5>";
    if ($dataUser['level'] == 0) {
        $result = ' <li>
           ' . $name . '
            <div id="menucon">
...
// product theo trademark 
if(isset($_GET['id'])){
    $id=$_GET['id'];
    $trademark_pro="SELECT * FROM trademark inner join product on trademark.id_trademark = product.ma_sp where id_trademark='$id'";
    $query=mysqli_query($new,$trademark_pro);
    $bien=mysqli_fetch_array($query);
    $name_trad=$bien['name_trademark'];
}
?>
...
<section class="container">
        <!-- hàng 1 -->
        <div class="tieude">
            <h2> Thương Hiệu  <?php global $name_trad;echo $name_trad; ?>  </h2>
        </div>
